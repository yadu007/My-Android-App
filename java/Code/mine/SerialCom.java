    ...
    try {
        ...
        if (serialPort != null) {
            ...
            if (serialPort.open()) {
                ...
                // serialPort.close();
                //String doc2 = new String(s, "UTF-8");
   ...
   public UsbSerialInterface.UsbReadCallback mCallback = new UsbSerialInterface.UsbReadCallback()
    {
        ...
        {try {
          ...
          //  Toast.makeText(SerialCom.this, "kitty", Toast.LENGTH_SHORT).show();
           // return;
           /// try{
               // String data = new String(arg0, "UTF-8");
            ...
            //}
           // catch (Exception ee){
            //    Toast.makeText(getBaseContext(), ee.toString(), Toast.LENGTH_SHORT).show();
           // }
        }
    };
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
             ...
             TextView Text=(TextView) findViewById(R.id.textView);
               ...
               // EditText mEdit = (EditText) findViewById(R.id.edittext);
              //  Toast.makeText(SerialCom.this, text.toString(), Toast.LENGTH_SHORT).show();
            }
            catch (Exception e){
